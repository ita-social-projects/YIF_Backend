namespace YIF.Shared
{
    public class ProjectRoles
    {
        ...
        public static string InstitutionOfEducationAdmin = "InstitutionOfEducationAdmin";
        public static string InstitutionOfEducationModerator = "InstitutionOfEducationModerator";
