...
namespace YIF_XUnitTests.Integration.YIF_Backend.Controllers
{
    public class InstitutionOfEducationAdminControllerTests : TestServerFixture
    {
        ...
        [Fact]
        public async Task ModifyOfInstitution_ShouldReturnOk()
        {
            // Arrange
