...
namespace YIF_XUnitTests.Unit.YIF.Core.Domain.Repositories
{
    public class UniversityModeratorRepositoryTests
    {
        ...
        private readonly UniversityModeratorRepository _universityModeratorRepository;
        ...
        public UniversityModeratorRepositoryTests()
        {
            ...
            _universityModeratorRepository = new UniversityModeratorRepository(_mapperMock.Object, _userManagerMock, _dbContextMock.Object);
        ...
        {
            string a = await _universityModeratorRepository.AddUniModerator(universityModerator);
